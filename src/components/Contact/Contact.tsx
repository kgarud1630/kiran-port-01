      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            Ready to discuss your next project or explore how I can help optimize your infrastructure? 
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="infrastructure-consultation">Infrastructure Consultation</option>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Remote-First • Open to Travel</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">View my projects and contributions</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">Professional networking and updates</p>
                  </div>
                </a>
              </div>
            </div>
